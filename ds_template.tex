...
%\begin{review}{editor}
%\author{\fnms{First} \snm{Editor}\address{\institution{University or Company name}, \cny{Country}}}
%\author{\fnms{Second} \snm{Editor}\address{\institution{First University or Company name}, \cny{Country}
%    and \institution{Second University or Company name}, \cny{Country}}}
%\end{review}
%\begin{review}{solicited}
%\author{\fnms{First} \snm{Solicited reviewer}\address{\institution{University or Company name}, \cny{Country}}}
%\end{review}
